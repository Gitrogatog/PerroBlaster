...
namespace ContentBuilderUI
{
	...
	{
		private string ShaderContentPath = "Content/Shaders";//Path.Combine("Content", "Shaders");
		...
		void Uppers()
		{
			...
			ImGui.PushStyleColor(ImGuiCol.WindowBg, new Vector4(24f / 255f, 18f / 255f, 18f / 255f, 1));
			ImGui.PushStyleColor(ImGuiCol.Text, new Vector4(0, 0, 0, 1));
			ImGui.NewFrame();

			ImGui.SetNextWindowSize(new Vector2(MainWindow.Width, MainWindow.Height));
